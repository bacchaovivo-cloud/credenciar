...
export default function Menu() {
  ...
  return (
    <nav className="glass-effect relative top-0 left-0 right-0 z-50 px-4 md:px-6 py-3 flex justify-between items-center text-slate-900 dark:text-white min-h-[72px]">
