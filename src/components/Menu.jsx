  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 pt-4 pointer-events-none">
        <nav className="mx-auto w-full max-w-[1400px] bg-[#1a2333]/85 backdrop-blur-xl border border-[#2a374a] rounded-2xl px-4 py-2.5 flex justify-between items-center text-slate-300 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.5)] pointer-events-auto relative">
